      ...
      <div className="landing-page" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <section className="landing-hero page-container" style={{
          ...
          <div className="landing-hero-buttons" style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 28 }}>
            <button onClick={() => router.push('/monopoly/watch')} style={{
            ...
            <button onClick={() => router.push('/monopoly/agents')} style={{
              padding: '14px 36px', borderRadius: 12, cursor: 'pointer',
          ...
          <div className="landing-jump" style={{ display: 'flex', gap: 8, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <input placeholder="ID" value={gameId} onChange={(e) => setGameId(e.target.value)}
              onKeyDown={(e) => e.key === 'Enter' && gameId && router.push(`/monopoly/watch/lobby/${gameId}`)}
              style={{
                width: 56, padding: '7px 10px', borderRadius: 8, fontSize: 13,
                background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)',
                color: '#fff', textAlign: 'center', fontFamily: 'var(--font-mono)',
              }} />
            <button onClick={() => gameId && router.push(`/monopoly/watch/lobby/${gameId}`)} style={{
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 24 }}>
            ...
            <Link href="/monopoly/watch" style={{ fontSize: 13, color: 'var(--text-muted-soft)', textDecoration: 'none' }}>Spectate</Link>
            <Link href="/monopoly/agents" style={{ fontSize: 13, color: 'var(--text-muted-soft)', textDecoration: 'none' }}>Agents</Link>
          </div>
        </footer>
      </div>
    </div>
