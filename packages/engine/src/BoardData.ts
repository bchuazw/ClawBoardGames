...
export interface TileDef {
  ...
  rentWithHouses?: [number, number, number, number]; // rent with 1, 2, 3, 4 houses (color groups 1-8 only)
  houseCost?: number; // cost to build one house (color groups 1-8 only)
}
...
export const TILES: TileDef[] = [
  ...
  { position: 1,  name: "Mediterranean Ave",   type: TileType.PROPERTY,     propertyIndex: 0,  group: 1,  price: 60,  baseRent: 2,   mortgageValue: 30,  rentWithHouses: [10, 30, 90, 160],   houseCost: 50 },
  { position: 2,  name: "Community Chest",      type: TileType.COMMUNITY,    propertyIndex: -1, group: 0,  price: 0,   baseRent: 0,   mortgageValue: 0 },
  { position: 3,  name: "Baltic Ave",           type: TileType.PROPERTY,     propertyIndex: 1,  group: 1,  price: 60,  baseRent: 4,   mortgageValue: 30,  rentWithHouses: [20, 60, 180, 320],   houseCost: 50 },
  ...
  { position: 6,  name: "Oriental Ave",         type: TileType.PROPERTY,     propertyIndex: 3,  group: 2,  price: 100, baseRent: 6,   mortgageValue: 50,  rentWithHouses: [30, 90, 270, 400],   houseCost: 50 },
  { position: 7,  name: "Chance",               type: TileType.CHANCE,       propertyIndex: -1, group: 0,  price: 0,   baseRent: 0,   mortgageValue: 0 },
  { position: 8,  name: "Vermont Ave",          type: TileType.PROPERTY,     propertyIndex: 4,  group: 2,  price: 100, baseRent: 6,   mortgageValue: 50,  rentWithHouses: [30, 90, 270, 400],   houseCost: 50 },
  { position: 9,  name: "Connecticut Ave",      type: TileType.PROPERTY,     propertyIndex: 5,  group: 2,  price: 120, baseRent: 8,   mortgageValue: 60,  rentWithHouses: [40, 100, 300, 450],  houseCost: 50 },
  { position: 10, name: "Jail / Just Visiting", type: TileType.JAIL,         propertyIndex: -1, group: 0,  price: 0,   baseRent: 0,   mortgageValue: 0 },
  { position: 11, name: "St. Charles Place",    type: TileType.PROPERTY,     propertyIndex: 6,  group: 3,  price: 140, baseRent: 10,  mortgageValue: 70,  rentWithHouses: [50, 150, 450, 625],  houseCost: 100 },
  { position: 12, name: "Electric Company",     type: TileType.UTILITY,      propertyIndex: 7,  group: 10, price: 150, baseRent: 4,   mortgageValue: 75 },
  { position: 13, name: "States Ave",           type: TileType.PROPERTY,     propertyIndex: 8,  group: 3,  price: 140, baseRent: 10,  mortgageValue: 70,  rentWithHouses: [50, 150, 450, 625],  houseCost: 100 },
  { position: 14, name: "Virginia Ave",         type: TileType.PROPERTY,     propertyIndex: 9,  group: 3,  price: 160, baseRent: 12,  mortgageValue: 80,  rentWithHouses: [60, 180, 500, 700],  houseCost: 100 },
  ...
  { position: 16, name: "St. James Place",      type: TileType.PROPERTY,     propertyIndex: 11, group: 4,  price: 180, baseRent: 14,  mortgageValue: 90,  rentWithHouses: [70, 200, 550, 750],  houseCost: 100 },
  { position: 17, name: "Community Chest",      type: TileType.COMMUNITY,    propertyIndex: -1, group: 0,  price: 0,   baseRent: 0,   mortgageValue: 0 },
  { position: 18, name: "Tennessee Ave",        type: TileType.PROPERTY,     propertyIndex: 12, group: 4,  price: 180, baseRent: 14,  mortgageValue: 90,  rentWithHouses: [70, 200, 550, 750],  houseCost: 100 },
  { position: 19, name: "New York Ave",         type: TileType.PROPERTY,     propertyIndex: 13, group: 4,  price: 200, baseRent: 16,  mortgageValue: 100, rentWithHouses: [80, 220, 600, 800],  houseCost: 100 },
  { position: 20, name: "Free Parking",         type: TileType.FREE_PARKING, propertyIndex: -1, group: 0,  price: 0,   baseRent: 0,   mortgageValue: 0 },
  { position: 21, name: "Kentucky Ave",         type: TileType.PROPERTY,     propertyIndex: 14, group: 5,  price: 220, baseRent: 18,  mortgageValue: 110, rentWithHouses: [90, 250, 700, 875],  houseCost: 150 },
  { position: 22, name: "Chance",               type: TileType.CHANCE,       propertyIndex: -1, group: 0,  price: 0,   baseRent: 0,   mortgageValue: 0 },
  { position: 23, name: "Indiana Ave",          type: TileType.PROPERTY,     propertyIndex: 15, group: 5,  price: 220, baseRent: 18,  mortgageValue: 110, rentWithHouses: [90, 250, 700, 875],  houseCost: 150 },
  { position: 24, name: "Illinois Ave",         type: TileType.PROPERTY,     propertyIndex: 16, group: 5,  price: 240, baseRent: 20,  mortgageValue: 120, rentWithHouses: [100, 300, 750, 925], houseCost: 150 },
  { position: 25, name: "B&O Railroad",         type: TileType.RAILROAD,     propertyIndex: 17, group: 9,  price: 200, baseRent: 25,  mortgageValue: 100 },
  { position: 26, name: "Atlantic Ave",         type: TileType.PROPERTY,     propertyIndex: 18, group: 6,  price: 260, baseRent: 22,  mortgageValue: 130, rentWithHouses: [110, 330, 800, 975], houseCost: 150 },
  { position: 27, name: "Ventnor Ave",          type: TileType.PROPERTY,     propertyIndex: 19, group: 6,  price: 260, baseRent: 22,  mortgageValue: 130, rentWithHouses: [110, 330, 800, 975], houseCost: 150 },
  { position: 28, name: "Water Works",          type: TileType.UTILITY,      propertyIndex: 20, group: 10, price: 150, baseRent: 4,   mortgageValue: 75 },
  { position: 29, name: "Marvin Gardens",       type: TileType.PROPERTY,     propertyIndex: 21, group: 6,  price: 280, baseRent: 24,  mortgageValue: 140, rentWithHouses: [120, 360, 850, 1025],houseCost: 150 },
  { position: 30, name: "Go To Jail",           type: TileType.GO_TO_JAIL,   propertyIndex: -1, group: 0,  price: 0,   baseRent: 0,   mortgageValue: 0 },
  { position: 31, name: "Pacific Ave",          type: TileType.PROPERTY,     propertyIndex: 22, group: 7,  price: 300, baseRent: 26,  mortgageValue: 150, rentWithHouses: [130, 390, 900, 1100],houseCost: 200 },
  { position: 32, name: "North Carolina Ave",   type: TileType.PROPERTY,     propertyIndex: 23, group: 7,  price: 300, baseRent: 26,  mortgageValue: 150, rentWithHouses: [130, 390, 900, 1100],houseCost: 200 },
  { position: 33, name: "Community Chest",      type: TileType.COMMUNITY,    propertyIndex: -1, group: 0,  price: 0,   baseRent: 0,   mortgageValue: 0 },
  { position: 34, name: "Pennsylvania Ave",     type: TileType.PROPERTY,     propertyIndex: 24, group: 7,  price: 320, baseRent: 28,  mortgageValue: 160, rentWithHouses: [150, 450, 1000, 1200],houseCost: 200 },
  ...
  { position: 37, name: "Park Place",           type: TileType.PROPERTY,     propertyIndex: 26, group: 8,  price: 350, baseRent: 35,  mortgageValue: 175, rentWithHouses: [175, 500, 1100, 1300],houseCost: 200 },
  { position: 38, name: "Luxury Tax",           type: TileType.TAX,          propertyIndex: -1, group: 0,  price: 0,   baseRent: 0,   mortgageValue: 0 },
  { position: 39, name: "Boardwalk",            type: TileType.PROPERTY,     propertyIndex: 27, group: 8,  price: 400, baseRent: 50,  mortgageValue: 200, rentWithHouses: [200, 600, 1400, 1700],houseCost: 200 },
];
